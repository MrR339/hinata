  ...
  global.multiplier = 90// Semakin Besar Angkanya Semakin Sulit Untuk Naik Level
  global.limitCount = 70 // 70 Dah Pas Banh
  global.prefa = ['','.','/','#']

  // Other
  global.ownername = 'Raditya Ganz' // Ganti Jadi Namamu
  global.owner = ['6285871057403','6285871057403','6285871057403'] // Kalo Mau Lebih Tambahin Aja
  global.ownernomer = '6285871057403' // Owner Utama Istilahnya
  global.botname = 'InlineX_Botz' // Ganti Jadi Nama Botmu
  global.packname = 'InlineX_Botz' // Sticker Weem
  global.author = 'Raditya Ganz' // Sticker Weem
  global.webme = 'https://botgratis.my.id' // Ganti Sama Web Mu
  global.linkgroup = 'Close Kak' // Ganti Sama Link Gc Mu
  global.sessionName = 'session'
  global.youtube = 'Gapunya Chanel Kak' // Ganti Sama Link Yt Mu
  global.github = 'Rahasia Ygy' // Ganti Sama Link Github
  global.instagram = 'https://instagram.com/raditaganz' // Ganti Sama Link Ig mu
